...
CHECKPOINT_EVERY = 50000  # rows between checkpoints
...
# --- Checkpoint helpers ---
def save_checkpoint(processed_ids, new_rows):
    checkpoint_data = {
...
# --- main parallel logic with checkpointing ---
        ...
        for row_dict in retweet_dicts:
            ...
            while not result_queue.empty():
                ...
                if processed_count % CHECKPOINT_EVERY == 0:
                    save_checkpoint(processed_ids, new_rows)
